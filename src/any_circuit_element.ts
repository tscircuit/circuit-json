...
export const any_circuit_element = z.union([
  ...
  src.source_board,
  src.source_assembly_device,
  src.source_fdm_enclosure,
  src.source_cutout_aperture,
  ...
  src.source_component_pins_underspecified_warning,
  src.source_pin_must_be_connected_error,
  src.unknown_error_finding_part,
  src.source_part_not_found_warning,
  ...
  sim.simulation_dc_operating_point_voltage,
  sim.simulation_dc_operating_point_current,
  sim.simulation_dc_sweep_voltage_graph,
  sim.simulation_dc_sweep_current_graph,
